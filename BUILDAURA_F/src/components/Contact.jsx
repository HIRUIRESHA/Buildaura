                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="h-12 w-full border border-gray-200 rounded-md px-3 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                        />
                      </div>
                      <div className="space-y-2">
                        <label
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        type="text"
                        id="subject"
                        placeholder="e.g., Commercial Building, Residential Complex, Office Space"
                        className="h-12 w-full border border-gray-200 rounded-md px-3 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full border border-gray-200 rounded-md px-3 py-2 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 resize-none"
                      />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                      <button
                        type="submit"
                        className="bg-orange-500 hover:bg-orange-600 text-white h-12 px-8 flex-1 sm:flex-none rounded-md flex items-center justify-center gap-2"
                      >
                      ...
                      <button
                        type="button"
                        className="border border-gray-200 hover:bg-gray-50 text-gray-700 h-12 px-8 rounded-md flex items-center justify-center gap-2"
                      >
